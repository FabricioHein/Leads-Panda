                        ...
                        <div class="user-list-box" :class="{ 'user-list-box-show': is_show_user_menu }">
                            ...
                            <div class="panel-body justify-pill tabs">
                                <ul class="nav nav-pills mb-3 mt-3 nav-fill" id="abertos-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="abertos-home-tab" data-bs-toggle="pill"
                                            href="#abertos-home" role="tab" aria-controls="abertos-home"
                                            aria-selected="true">Abertos</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="fechados-tab" data-bs-toggle="pill" href="#fechados"
                                            role="tab" aria-controls="fechados" aria-selected="false">Fechados</a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="abertos-tabContent">
                                    <div class="tab-pane fade show active" id="abertos-home" role="tabpanel"
                                        ...
                                        <perfect-scrollbar class="people"
                                            ...
                                            <div v-for="(person, index) in filterd_contact_list" class="person" :key="index"
                                                ...
                                                <div class="user-info">
                                                    <div class="f-head">
                                                        <img :src="require(`@/assets/images/user-no-foto.png`)"
                                                            alt="avatar" />
                                                    </div>
                                                    <div class="f-body">
                                                        <div class="meta-info">
                                    ...
                                    <div class="tab-pane fade" id="fechados" role="tabpanel" aria-labelledby="fechados-tab">
                                        <perfect-scrollbar class="people"
                                            ...
                                            <div v-for="(person, index) in filterd_contact_list_close" class="person"
                                                :key="index"
                                                :class="{ active: selected_user && selected_user.chat_id == person.chat_id }"
                                                @click="select_user(person)">
                                                <div class="user-info">
                        ...
                        <div class="painel-modelo">
                            <div class="mt-container">
                                ...
                                <div class="p-2" v-if="selected_user">
                                    ...
                                    <input class="form-control" v-model="selected_user.telefone"
                                        type="text" />
                                </div>
                                <div class="p-2" v-if="selected_user">
...
export default {
    ...
    methods: {
        ...
        async select_user(chat) {
            ...
            const chatUuid = chat.chat_info.uuid;
        ...
        search_users() {
            this.filterd_contact_list = this.contact_list.filter((d) => d.nome.toLowerCase().includes(this.search_user));

            this.filterd_contact_list_close = this.contact_list_close.filter((d) => d.nome.toLowerCase().includes(this.search_user));
