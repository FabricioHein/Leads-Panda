...
exports.HistoricoClienteRepository = void 0;
const PrismaService_1 = require("../base/relacional/PrismaService");
const common_1 = require("@nestjs/common");
let HistoricoClienteRepository = class HistoricoClienteRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
...
HistoricoClienteRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [PrismaService_1.PrismaService])
], HistoricoClienteRepository);
exports.HistoricoClienteRepository = HistoricoClienteRepository;
//# sourceMappingURL=historico-cliente.repository.js.map